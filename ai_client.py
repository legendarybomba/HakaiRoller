...
class OracleFish:
    ...
    def generate_challenge(self, game: str, difficulty: str) -> dict:
        system_instruction = (
            ...
            "DIFFICULTY SCALE DEFINITIONS:\n"
            " - Easy: Straightforward tasks, low pressure, light requirements.\n"
            " - Heated: Moderate challenge, requires tactical focus, slight friction or limitations.\n"
            " - Hard: Brutal, high-stakes, maximum friction, near-impossible survival requirements.\n\n"
